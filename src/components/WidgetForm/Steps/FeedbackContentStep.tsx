...
interface FeedbackContentProps {
    ...
    onFeedbackRestartRequested: () => void; //não recebe parâmetro e não possui retorno
    onFeedbackSent: () => void;
}

export const FeedbackContentStep = ({feedbackType,onFeedbackRestartRequested, onFeedbackSent}: FeedbackContentProps) => { 
